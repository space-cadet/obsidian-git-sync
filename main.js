...
var GitManager = class {
  constructor(dir, credentials, statusBarItem) {
    this.statusBarItem = null;
    this.dir = dir;
    this.credentials = credentials;
    this.statusBarItem = statusBarItem || null;
    this.git = esm_default(this.dir);
  }
  ...
  async initializeRepo(repoUrl, branchName) {
    try {
      ...
      if (!isRepo) {
        ...
        const remoteWithAuth = repoUrl.replace(
          "https://",
...
var VIEW_TYPE_GITSYNC = "obsidian-git-sync-view";
var GitSyncView = class extends import_obsidian2.ItemView {
  ...
  async syncVault() {
    ...
    if (!this.gitManager) {
      const credentials = {
        ...
        author: {
          name: this.settings.author.name || "Default Name",
          // Ensure a default name is provided
          email: this.settings.author.email
        }
      };
      if (this.statusBarItem) {
